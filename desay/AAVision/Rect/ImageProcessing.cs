...
namespace Vision_Assistant
{
    static class Image_Processing
    {
        ...
        public static PaletteType ProcessImage(VisionImage image)
        {
            ...
            RectangleContour vaRect = new RectangleContour(1000, 700, 2250, 1850);
            roi.Add(vaRect);
            // Geometric Matching
			...
			matchGPMOptions.Mode = GeometricMatchModes.RotationInvariant | GeometricMatchModes.OcclusionInvariant;
            matchGPMOptions.NumberOfMatchesRequested = 2;
			double[] vaRangesMin = {-20, 0, 50, 0};
			double[] vaRangesMax = {20, 0, 200, 10};
